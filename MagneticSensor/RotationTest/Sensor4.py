...
folderPath = "C:\\Users\\hyukk\\Desktop\\Rotation\\result\\"
...
scaledSensor4.plot(kind= "line", ax= ax[1, 0], title= "Sensor4").legend(loc= "center right", bbox_to_anchor= (1.2, 0.5))
scaledSensor5.plot(kind= "line", ax= ax[1, 1], title= "Sensor5").legend(loc= "center right", bbox_to_anchor= (1.2, 0.5))
scaledSensor6.plot(kind= "line", ax= ax[1, 2], title= "Sensor6").legend(loc= "center right", bbox_to_anchor= (1.2, 0.5))
