...
if sys.platform == "darwin":
    ...
    plotResult(50, 1000, scaledSensor1, "Sensor 1")
    plotResult(50, 1000, scaledSensor2, "Sensor 2")
    plotResult(50, 1000, scaledSensor3, "Sensor 3")
    # plotResult(50, 1000, scaledSensor4, "Sensor 4")
    # plotResult(50, 1000, scaledSensor5, "Sensor 5")
    # plotResult(50, 1000, scaledSensor6, "Sensor 6")
    plt.show()

else:
    print("Pleas run in mac")